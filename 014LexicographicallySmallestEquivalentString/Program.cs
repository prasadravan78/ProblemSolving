...
namespace _014LexicographicallySmallestEquivalentString
{
    /*
    ...
    */
    internal class Program
    {
        ...
        {
            Console.WriteLine(SmallestEquivalentString("leetcode", "programs", "sourcecode"));
            Console.ReadLine();
        }
        ...
        public static string SmallestEquivalentString(string s1, string s2, string baseStr)
        {
            ...
            {
                var min = array[s1[i] - 'a'];
                var max = array[s2[i] - 'a'];
            ...
            return new String(baseStr.Select(k => array[k - 'a']).ToArray());
        }
    }
}