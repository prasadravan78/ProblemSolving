namespace _012NumberOfNodesInSubTree
{
    /*
    ...
    */
    internal class Program
    {
        ...
        {
            var resonse = CountSubTrees(7, new int[][] { new int[] { 0, 1 }, new int[] { 0, 2 }, new int[] { 1, 4 }, new int[] { 1, 5 }, new int[] { 2, 3 }, new int[] { 2, 6 } }, "abaedcd");
            Console.ReadLine();
        }
        ...
        public static int[] CountSubTrees(int n, int[][] edges, string labels)
        {
            ...
            DFS(graph, labels, 0, -1, ref response);

            return response;
        }

        private static int[] DFS(List<IList<int>> graph, string labels, int curr, int prev, ref int[] response)
        {
            ...
            foreach (var next in graph[curr])
            {
                ...
                var temp = DFS(graph, labels, next, curr, ref response);
            ...
            response[curr] = bucket[labels[curr] - 'a'];
